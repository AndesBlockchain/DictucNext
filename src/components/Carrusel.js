      ...
      return (
            <div className="relative z-0 isolate">
              ...
              <div className="w-full bg-gray-50 flex items-center justify-center shadow-md relative">
                <button onClick={anteriorImagen} className="sm:invisible absolute left-2 top-1/2 -translate-y-1/2 bg-white bg-opacity-70 rounded-full p-2 shadow hover:bg-opacity-100 transition-all z-5">
