...
const TIPOS_DENUNCIA = [
  { value: 'fraude_corrupcion', label: 'Delitos de fraude y corrupciónv económica' },
  { value: 'delitos_informaticos', label: 'Delitos informáticos' },
  { value: 'competencia_desleal', label: 'Delitos de libre competencia' },
  { value: 'delitos_tributarios', label: 'Delitos tributarios' },
  { value: 'infracciones_laborales', label: 'Delitos laborales y de seguridad social' },
  { value: 'delitos_ambientales', label: 'Delitos ambientales' },
  { value: 'propiedad_intelectual', label: 'Delitos de propiedad intelectual e industrial' },
  { value: 'delitos_sa', label: 'Delitos de Sociedad Anónima' },
  { value: 'delitos_epidemia_catastrofe', label: 'Delitos de epidemia y catástrofe' },
  { value: 'delitos_laborales_integridad_fisica', label: 'Delitos laborales contra la integridad física' },
  { value: 'delitos_forestales', label: 'Delitos forestales, pesca acuicultura' },
  { value: 'delitos_sustancias_peligrosas', label: 'Delitos sustancias y residuos peligrosos' },
  { value: 'adulteracion_documentos', label: 'Adulteración o falsificación de documentos' },
  { value: 'divulgacion_info_confidencial', label: 'Divulgación de información confidencial o uso de propiedad intelecutal de la compañia' },
  { value: 'desigualdad_genero', label: 'Inequidad de género' },
