...
const useServiciosBySector = async (sectorSlug) => {
  ...
  const path = `/api/servicios?filters[sectores_pais][slug][$eq]=${sectorSlug}&fields[0]=nombre&fields[1]=slug&fields[2]=contenido&pagination[limit]=1000&populate[0]=tipo_de_servicio&populate[1]=sectores_pais&populate[2]=unidad`;
